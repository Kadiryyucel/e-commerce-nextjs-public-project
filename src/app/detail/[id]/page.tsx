          ...
          <div className='xl:w-[38rem] mx-4'>
            ...
            <div>
              ...
              <ul className='info-about-product text-xs md:text-xl'>
                ...
                <li>Bu üründen en fazla 10 adet sipariş verilebilir. 10 adedin üzerindeki siparişleri MAMA iptal etme hakkını saklı tutar. Belirlenen bu limit kurumsal siparişlerde geçerli olmayıp, kurumsal siparişler için farklı limitler belirlenebilmektedir.</li>
